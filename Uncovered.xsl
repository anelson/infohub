...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:msxsl="urn:schemas-microsoft-com:xslt">
        ...
        <html>
            ...
            <body>
                <div class="title">Missed Code Coverage Report</div>
                <p></p>
                <ul>
                    <xsl:for-each select="module[method/seqpnt/@visitcount=0]">
                        <div class="assembly">
                            <a>
                                <xsl:attribute name="href">#<xsl:value-of select="@assembly"/></xsl:attribute>
    ...
    <xsl:template match="module[method/seqpnt/@visitcount=0]">
        <a>
    ...
    <xsl:template match="seqpnt[@visitcount=0]">
        <tr>
        <td class="datacell">
